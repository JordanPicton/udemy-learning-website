...
// This cleans up the code somewhat due to it not needing another clause to repeat something that's already being done just with a different value.
// It's better to just add that extra condition.
if (age <= 3 || age >= 65) {
    console.log("You go in for free!");
} else if (age <= 12) {
    console.log("Price is £3 to enter.")
